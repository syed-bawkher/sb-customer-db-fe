    ...
    const fetchJacketData = async () => {
      try {
        ...
        data = data.filter(entry => {
          const { jacket_length, natural_length, back_length, x_back, half_shoulder, to_sleeve, chest, waist, collar } = entry;
          return [jacket_length, natural_length, back_length, x_back, half_shoulder, to_sleeve, chest, waist, collar].some(val => val !== null);
        });
        setJacketData(data);
      } catch (error) {
